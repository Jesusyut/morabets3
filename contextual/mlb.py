...
def get_mlb_contextual_hit_rate(player_name:str, stat_type:str, threshold:float):
    """
...
def get_mlb_contextual_hit_rate_cached(player_name: str, stat_type: str, threshold: float):
    """
    Thin caching wrapper over your existing get_mlb_contextual_hit_rate().
