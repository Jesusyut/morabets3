...
CACHE_SEC_EVENTS = int(os.getenv("NCAAF_EVENTS_CACHE_SEC", "60"))
CACHE_SEC_EVENT_ODDS = int(os.getenv("NCAAF_EVENT_ODDS_CACHE_SEC", "60"))

_sess = requests.Session()
_sess.headers.update({"User-Agent":"MoraBets/1.0 (+NCAAF v4)"})
